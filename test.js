...
const teams = [
    { team_name: 'backend', members: [{ user_id: 'u1', username: 'Alice', is_active: true }, { user_id: 'u2', username: 'Bob', is_active: true }] },
    { team_name: 'frontend', members: [{ user_id: 'u3', username: 'Charlie', is_active: true }, { user_id: 'u4', username: 'Diana', is_active: true }] },
];
